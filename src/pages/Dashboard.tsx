...
import { Users, TrendingUp, DollarSign, Wrench, Plus, MessageSquare, LogOut } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="glass p-6 rounded-2xl">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-semibold">Partnership Score</h3>
            </div>
            <p className="text-3xl font-bold">8.5/10</p>
            <p className="text-sm text-muted-foreground mt-1">Trust & authenticity</p>
          </div>
          <div className="glass p-6 rounded-2xl">
            <div className="flex items-center gap-3 mb-2">
